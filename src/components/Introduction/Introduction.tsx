            ...
            <div className="w-full h-full bg-gradient-to-r from-[#131424]/10 via-black/30 to-black/10">
                <div className="container grid items-center h-full px-5 mx-auto md:grid-cols-2 md:text-left">
                    ...
                    <motion.div variants={fadeIn("left", 0.5)}
                        ...
                        exit="hidden"
                    >
                        <h1 className="mb-5 text-4xl leading-tight md:mb-10">The Magic  <br />
                            <span className="text-secondary">of Coding</span></h1>
                        <p className="max-w-sm  mb-10 text-xl md:max-w-2xl md:mx-0 md:mb-16 md:text-xl">
                        Code with magic, magic with code
                        </p>
                        ...
                        <div className="flex flex-col items-center gap-3 md:gap-10 md:flex-row">
                            ...
                            <a href="/" className="px-6 py-3 my-2 transition-all border-2 cursor-pointer text-secondary border-secondary rounded-xl hover:shadow-xl hover:shadow-secondary">
